...
namespace ImGui
{
	...
	IMGUI_API void			VRenderText(ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash, ImColor custom);
	IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width);
	IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
	IMGUI_API void          VRenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL, ImColor color = ImColor());
	...
	IMGUI_API void          Tab_ButtonEx(const char* label, int& enabled, int best = 0, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
	...
	IMGUI_API bool          SliderBehavior(const ImRect& frame_bb, ImGuiID id, const char* display_format, const char* label, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags = 0);
...
IMGUI_API void              ImFontAtlasBuildSetupFont(ImFontAtlas* atlas, ImFont* font, ImFont_config* font_config, float ascent, float descent);
