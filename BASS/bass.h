...
#define BASS_IOSNOTIFY_INTERRUPT_END	2	// interruption ended
	...
	inline BOOL BASS_Set_config(DWORD option, DWORD value)
	{
		return reinterpret_cast<BOOL(__stdcall*)(DWORD, DWORD)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Set_config")))(option, value);
	}

	inline DWORD BASS_Get_config(DWORD option)
	{
		return reinterpret_cast<DWORD(__stdcall*)(DWORD)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Get_config")))(option);
	}

	BOOL BASSDEF(BASS_Set_configPtr)(DWORD option, const void *value);
	void *BASSDEF(BASS_Get_configPtr)(DWORD option);
...
static inline BOOL BASS_Set_configPtr(DWORD option, const WCHAR *value)
{
	return BASS_Set_configPtr(option | BASS_UNICODE, (const void*) value);
}
#endif
#endif
