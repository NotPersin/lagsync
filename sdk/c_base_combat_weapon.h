...
public:
	...
	netvar(modelindex(), int, "CBaseCombatWeapon", "m_nModelIndex");
};
...
public:
	...
	vfunc(483, update_accuracy(), void(__thiscall*)(void*))()
	...
	vfunc(17, get_pred_desc_map(), datamap_t* (__thiscall*)(c_base_combat_weapon*))()
	netvar(get_weapon_mode(), int, "CWeaponCSBase", "m_weaponMode")
	datamap(get_activity(), int, "m_Activity")
	...
	int* FallbackSeed()
	{
		return (int*)((uintptr_t)this + 0x31BC);
	}
...
public:
	...
	offset(get_c4_blow_time(), float, 0x2990)
};

struct c_cs_inferno : public c_base_entity
{
	offset(get_entity_spawn_time(), float, 0x20)
