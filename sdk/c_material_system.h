...
class ITexture;
class IMaterialSystemHardware_config;
class CShadowMgr;
...
public:
	...
	virtual IMaterialSystemHardware_config*  GetHardware_config(const char *pVersion, int *returnCode) = 0;
	virtual void                            __unknown() = 0;
	virtual bool                            Update_config(bool bForceUpdate) = 0; //20
	virtual bool                            Override_config(const MaterialSystem_config_t &_configs, bool bForceUpdate) = 0;
	virtual const MaterialSystem_config_t&  GetCurrent_configForVideoCard() const = 0;
	virtual bool                            GetRecommended_configurationInfo(int nDXLevel, KeyValues * pKeyValues) = 0;
	...
	virtual bool                            SetMode(void* hwnd, const MaterialSystem_config_t &_configs) = 0;
